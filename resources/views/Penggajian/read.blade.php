...
@section('content')
    ...
    <div class="">
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <center>
                            <p><img width="120px" height="100px" src="<?php echo url('assets/image/') ?>/<?php echo $penggajian->TunjanganPegawai->Pegawai->photo; ?>" class="img-circle" alt="Cinque Terre" ></p>
                            <hr>
 ...
 <hr><a class="btn btn-primary col-md-12" href="{{url('penggajian')}}">Kembali</a>
